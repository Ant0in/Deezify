...
public class TestSong {
    ...
    public void testGetSongName() {
        Song song = new Song("Song1", "Artist1", "Style1", "Cover1", new Duration(1000));
    ...
    public void testEquals() {
        Song song1 = new Song("Song1", "Artist1", "Style1", "Cover1", new Duration(1000));
        Song song2 = new Song("Song1", "Artist1", "Style1", "Cover1", new Duration(1000));
