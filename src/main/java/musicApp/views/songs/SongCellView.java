...
public class SongCellView extends View {
     ...
     */
    public void setListener(SongCellViewListener _listener) {
        listener = _listener;
    }

    /**
     * Initializes the view. Called once when the view is created.
     * Sets up the buttons, icons, and context menu.
     */
    @Override
    public void init() {
        initComponents();
